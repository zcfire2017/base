...
public class CollectionExtend {
	 ...
	 * @return Set集合
	 */
	public static <E> Set<E> toOrderSet(@This Collection<E> collection, Predicate<E> predicate) {
		if (collection.isEmpty()) {
			return new HashSet<>();
		}
		return create(collection).toOrderSet(predicate);
	}
	 ...
	 * @return Set集合
	 */
	public static <E> Set<E> toOrderSet(@This Collection<E> collection) {
		if (collection.isEmpty()) {
			return new HashSet<>();
		}
	 ...
	 * @return map集合
	 */
	public static <E, R, P> Map<R, P> toOrderMap(@This Collection<E> collection, Predicate<E> predicate, Function<E, R> keyMapper, Function<E, P> valueMapper) {
		if (collection.isEmpty()) {
			return new HashMap<>();
		}
		return create(collection).toOrderMap(predicate, keyMapper, valueMapper);
	}
	 ...
	 * @return map集合
	 */
	public static <E, R, P> Map<R, P> toOrderMap(@This Collection<E> collection, Function<E, R> keyMapper, Function<E, P> valueMapper) {
		if (collection.isEmpty()) {
			return new HashMap<>();
		}
		return create(collection).toOrderMap(keyMapper, valueMapper);
	}
	 ...
	 * @return map集合
	 */
	public static <E, R> Map<R, E> toOrderMap(@This Collection<E> collection, Function<E, R> keyMapper) {
		if (collection.isEmpty()) {
			return new HashMap<>();
		}
		return create(collection).toOrderMap(keyMapper);
	}
